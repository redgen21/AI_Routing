...
class TestRegionPlanV2Data(unittest.TestCase):
 ...
 def test_metadata_policy_mode_is_forced_and_workbook_mismatch_rejected(self):
  ...
  result=canonicalize_workbook(b.getvalue(),META); self.assertEqual(result['rejects'][0]['error_code'],'CITY_METADATA_MISMATCH')
