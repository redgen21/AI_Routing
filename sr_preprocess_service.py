...
def main() -> None:
    ...
    parser.add_argument("--service-file", required=True, help="Raw service CSV file.")
    parser.add_argument("--output-file", required=True, help="Normalized output CSV file.")
    parser.add_argument("--config-file", default="config.json", help="Config file with geocoding settings.")
