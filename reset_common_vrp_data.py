...
def _default_context() -> tuple[str, str]:
    cfg = load_common_config(COMMON_CONFIG_PATH)
...
def reset_common_vrp_data(
    ...
    *,
    ...
    with get_db_connection(COMMON_CONFIG_PATH) as conn:
...
def main() -> None:
    default_subsidiary, default_city = _default_context()
